from funcoes.menu1 import *
from funcoes.menu2 import *
from funcoes.menu3 import *
#adicina dicionario nas lista
...
events = [['Super Bowl','ai','pedro2@gmail.com',['joao pessoa',10],[1,2,2024,18,30],['batman','batman@gmail.com'],['pikachu','pikachu@gmail.com']],['comic con 2025','ai','pedro2@gmail.com',['joao pessoa',20],[1,2,2024, 17, 0],['Jotaro Kujo', 'jojo@gmail.com']],['CCXP','ai','pedro2@gmail.com',['joao pessoa',10],[1,2,2024, 8, 20]],]
    ...
    if (op == 1):
        ...
        while (ope != 0):
            ...
            if(ope == 1):
                ...
                while (nome_e!='0' and not inscricao_eventos(nome,gmail,nome_e, events)):
                    nome_e = buscar_eventos(events)
            ...
            if (ope == 3):
                ...
                while (opi != 0):
                    ...
                    print('5-increver algum participante')
                    ...
                    if(opi == 5):
                        ...
                        ad_participante_eventos(gmail, nome_e, events)
